...
<!--+	
	...
	|*** file: apic2apigee.xconfiguration.XML2JSON.xsl
...
<!--+
    ...
    |********************************
    +-->
    <!-- This template matches the 'xml-to-json' element of the document -->
    <xsl:template match="xml-to-json" mode="x-configuration">
